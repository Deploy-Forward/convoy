...
`_WRITE_TOOLS = {"stamp", "note", "seat", "join", "launch", "onboard", "clone", "mint", "repos", "crew", "seated", "consent", "await_seated", "nudge"}`
...
- Public `tools/list` **must hide**: `seat`, `join`, `launch`, `onboard`,
  `clone`, `mint`, `repos`, `crew`, `seated`, `consent`, `await_seated`, `nudge`.
