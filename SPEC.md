...
Customer 1 talks to Grok Bot. Grok Bot opens synapses through Convoy. Each synapse lands on a harness the human already signed into. Three products, one thread.
...
| 7 | Durable convoy_id / attach / bring-up | bind+attach GREEN 2026-08-28 `cvy_<thread-a>` thread `customer1` — 3 attach rows and both seats (distinct `resume_key`) re-read 2026-09-01. Live resume hop is RED **by design** since 2026-08-31 (`273a345` no-steal lock), not a hang to fix. Live TUI bring-up RED. Not Phase 8. |
