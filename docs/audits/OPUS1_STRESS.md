...
**Worktree:** `C:\Users\<user>\ola\convoy-wt-opus` · **branch:** `fable-opus-opus` · **HEAD:** `b29c79b`
...
| Live layer (customer 1) | read-only `C:\Users\<user>\ola\da-integration\.convoy\{feed,seats,registry}.jsonl`, `id` | 30 feed rows, 2026-08-28 → 2026-09-01 |
| This thread's layer | `C:\Users\<user>\ola\fable-opus-root\.convoy\feed.jsonl` | my own ack row `2026-09-01T16:27:34.919938Z` |
...
- **Phase 7 attach claim corroborates:** `.convoy/id` = `cvy_<thread-a>`, three `attach` rows (`23:38:35Z`, `23:38:36Z`, `23:44:36Z`), both seats in `seats.jsonl` with distinct `resume_key`s.
