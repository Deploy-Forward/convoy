...
- Feature worktree: `C:\Users\<user>\ola\convoy-wt-targeted-launch`
- Branch: `feat/targeted-neuron-launch`
- Base: `8dd8644eb5fa0ec3b0e2ca0cf410ddc5bcd976f4`
- Thread root: `C:\Users\<user>\ola\fable-opus-root`
- Caller chair: `codex-fable-opus`
- Caller worktree: `C:\Users\<user>\ola\convoy-wt-fable`
...
```text
python -m convoy --root C:\Users\<user>\ola\fable-opus-root join \
  --to codex \
  --worktree C:\Users\<user>\ola\convoy-wt-pane-proof \
  --title pane-proof \
  --launch
```
...
| Stage | Evidence |
| --- | --- |
| Separate checkout | Detached worktree `C:\Users\<user>\ola\convoy-wt-pane-proof` at `8dd8644` |
...
| Stage | Evidence |
| --- | --- |
| Separate checkout | Detached worktree `C:\Users\<user>\ola\convoy-wt-pane-grok-proof` at `8dd8644` |
...
| Stage | Evidence |
| --- | --- |
| Separate checkout | `C:\Users\<user>\ola\convoy-wt-grok-lead` |
...
python -m convoy --root C:\Users\<user>\ola\fable-opus-root join \
  --to grok \
  --worktree C:\Users\<user>\ola\convoy-wt-grok-side \
  --title grok-side \
  --launch \
...
| Stage | Evidence |
| --- | --- |
| Separate checkout | Detached worktree `C:\Users\<user>\ola\convoy-wt-grok-side` at `9a0591d` |
